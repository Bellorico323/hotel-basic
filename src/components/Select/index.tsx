...
export function SelectInput({
  ...
  return (
    <Select.Root {...props}>
      <Select.Trigger className="group flex w-full items-center justify-between gap-2 rounded border border-zinc-200 px-3 py-2 text-zinc-600 shadow-sm focus-within:ring-2 focus-within:ring-blue-400 bg-zinc-100 focus:outline-none">
